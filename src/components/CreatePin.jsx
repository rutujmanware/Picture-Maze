            ...
            <div className='flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full'>
              ...
              <div className='flex flex-col'>
                <div>
                  ...
                  className='outline-none w-4/5 text-space border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'
                  >
                    <option value="other"
                    className='bg-white '
                    >
                    ...
                    {categories.map((category)=>(
                      ...
                      className='bg-white text-base border-0 outline-none capitalizetext-black'
                      value={category.name}
                      >
                        {category.name}
                      </option>
